"""
Django settings for LRA_Web project.
...
try:
    with open(str(BASE_DIR) + '\secret.json') as f:
...
INSTALLED_APPS = [
    ...
    'request_ip.apps.RequestIpConfig',
]
...
WSGI_APPLICATION = 'LRA_Web.wsgi.application'
